...
<div class="catalog_banner catalog_banner-school content__tour tour" style="background-image:url(<?=$theme_url?>/img/banners/school-bg-opt.webp)">
	<div class="school1_wrap_list-bg" style="background-image:url(<?=$theme_url?>/img/banners/scool-list-bg-opt.webp)"></div>
	<img class="school1_wrap_list" src="<?=$theme_url?>/img/banners/school-list-opt.webp">
	<img class="school1_wrap_kids" src="<?=$theme_url?>/img/banners/school-kids-opt.webp">
